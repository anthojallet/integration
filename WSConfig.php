...
echo "</div>";
    ...
    echo "<form action='./integrationLaunchWS.php' method='post'>";
    echo "<div style='width:100%; text-align:center; position:relative; font-weight:bold; color:#000000; margin-bottom:10px;'>";
    echo "Mon Message : ";
    echo '<input  style="width:200px; font-family:Tahoma, Geneva, Kalimati, sans-serif, Arial; font-size:15px;" placeholder="Message" type="text" maxlength="20" name="Message" id="Message">';
