...
if (isset($QueueName))
{
	$sql = "SELECT * FROM Queue WHERE IdUser='".$IdUser."' AND Type='".$Type."' AND Usag='".$Usage."';";
	...
	if (mysql_num_rows($sql_result) == 1)
	{
	  ...
	  $sql2 = "UPDATE Queue SET QueueName='".$QueueName."' WHERE IdQueue='".$row['IdQueue']."'";
	...
	else
	{
      ...
      $sql2 = "INSERT INTO Queue(QueueName,Usag,Type,IdUser, IdQM) VALUES ('".$QueueName."','".$Usage."','".$Type."','".$IdUser."', '".$row['IdQM']."')";
