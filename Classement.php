...
echo "<img height=100px src='./res/Classement.png'><BR>Classement";

echo "</div>";
echo "<BR>";
echo "<BR>";
echo "<div id='DivClassement' style='font-size:18px;'>";
echo "</div>";
echo "<BR>";
...
echo "<script>Classement(".$_COOKIE["IdUser"].",".$Belt.");</script>";
